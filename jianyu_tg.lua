...
Fk:loadTranslationTable {
  ...
  ["jy_taoqiu"] = [[逃囚]],
  [":jy_taoqiu"] = [[其他角色的结束阶段，若你的武将牌背面朝上，你可以立即将一张牌当无距离限制的【杀】使用。若此【杀】造成伤害，你翻面。]],
...
Fk:loadTranslationTable {
  ...
  ["jy_muhuo"] = [[目祸]],
  [":jy_muhuo"] = [[当一名角色受到伤害后，若你与其距离1以内且其未死亡，你可以摸X张牌（X为你已损失的体力值且至多为5）、将〖冒充〗状态改为阴。若该角色不为你，你本回合不能再对其使用牌。]],
  ["@jy_muhuo-turn"] = [[目祸]],
}
