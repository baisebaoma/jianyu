...
本包不作任何盈利使用，对本包中所提及的真实人物没有任何侮辱、歧视的想法，出于对他们的喜爱才制作他们的同人作品。如有疑问，请联系。

## 想游玩我们的武将？

1. 本扩展包已上线新月杀活动服：<a href="huosan.top">huosan.top</a>，欢迎试用！

2. 如果您有自己的新月杀服务器，请输入 `install https://gitee.com/baisebaoma/jianyu` 添加本扩展包即可。需要您的服务器上开启了[神话再临](https://gitee.com/notify-ctrl/shzl)扩展包才可正常游玩，否则会出现问题。

## 已实现武将

> 注：此处文本更新日期为2023/12/19，仅供参考，可能已有修改，请以游戏内描述为准。
...
![群·唐尚珺](./image/generals/avatar/tym__tangshangjun.jpg "群·唐尚珺")

> 该武将由我设计。

学习：<s>你是高考历史总得分王。这是你的第16次高考，你仍然在为了考上理想的大学而努力学习。</s>
  出牌阶段限一次，你可以做一道选择题。若选择正确，你可以获得一张想要的牌。这张牌将从场上随机位置（包括其他角色的区域、被移出游戏的牌、自己的区域等任何位置，甚至也可以是自己的手牌）到达你的手牌。

奋斗：使命技，出牌阶段限一次，你可以弃一张牌使得【学习】可以再使用一次。<br>
