...
Fk:loadTranslationTable {
  ...
  ["jy_guina"] = "归纳",
  [":jy_guina"] = [[出牌阶段限三次，你可以令一名角色回答一道行测真题。若正确，其获得一张其指定的非衍生牌名的牌，否则其获得“归纳”标记直到本阶段结束。你使用基本牌与普通锦囊牌时，额外指定有“归纳”的角色为目标；有“归纳”的角色受到伤害时，你摸两张牌。<br><font color="grey">收录2018-2024《行测》]] .. total_papers .. [[套共]] .. total_questions .. [[题，经人工筛选，不含图形推理、资料分析。</font>]],
  ["@jy_guina-phase"] = "归纳",
