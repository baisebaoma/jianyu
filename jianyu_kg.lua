...
Fk:loadTranslationTable {
  ...
  ["jy_guina"] = "归纳",
  [":jy_guina"] = [[出牌阶段限三次，你可以令一名角色回答一道行测真题。若正确，其指定一个牌名并获得一张该牌名的牌，否则其获得“归纳”直到本阶段结束。你使用基本牌与非延时类锦囊牌时，若持有“归纳”的角色不是目标，其也成为该牌的目标；持有“归纳”的角色受到伤害时，你摸一张牌。<br><font color="grey">〖归纳〗是非常灵活的技能。你可以〖归纳〗自己来获得关键牌、〖归纳〗队友并使用【桃】或【无中生有】来增益我方、〖归纳〗敌人来造成群体效果并过牌。请仔细规划使用时机和目标以获得最大收益。<br>收录2018-2023国家及各地区《行测》试卷]] .. total_papers .. [[套，共]] .. total_questions .. [[题，经人工筛选，不含图形推理、资料分析。<br>答对时，这张牌可能来自于任何位置，甚至你自己的区域。若你有同名牌，请先使用掉。</font>]],
  ["@jy_guina-phase"] = "归纳",
