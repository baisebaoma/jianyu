...
-- 简自豪
local jianzihao = General(extension, "jy_ex__jianzihao", "qun", 2)
...
-- 高天亮
local gaotianliang = General(extension, "jy_ex__gaotianliang", "qun", 3)
...
-- 水晶哥
local yangfan = General(extension, "jy_ex__yangfan", "qun", 3)
...
--   ["jy_jieyin_ex"] = "结姻",
--   [":jy_jieyin_ex"] = [[限定技，出牌阶段，你可以减少1点体力上限、令一名已受伤的男性角色回复3点体力，然后你获得其所有牌并拥有其所有技能。]],

--   ["jy_lihun_ex"] = "离婚",
--   [":jy_lihun_ex"] = [[出牌阶段，你可以减少3点体力上限使〖结姻〗视为未发动过。]],
