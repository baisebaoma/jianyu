...
对已经一年多的老武将简自豪进行翻新。也顺便重做了乐子人（但是仍然无法选用，因为在各种环境下太强或太弱。群友，甚至不记得是哪位群友，对武陆逊的拙劣模仿罢了）。
...
简自豪已经是一年多的老武将了，早就该重做了。他在人数多的对局中无法发挥，但又在人数少（尤其是单挑）的对局中极强。本次重做尝试平衡这一问题。
...
一些描述优化，就不一个一个写了。删除了一些冗余部分。继续重做了乐子人并且将他启用（但仍然不出现在将池中，因为强度未经测试）。

### 乐子人 4/4

最开始版本的乐子人（跳过摸牌阶段、看戏摸2、入局仅持续到下一个回合开始前）的强度完全取决于存活人数。现在尝试平衡这一问题，并让他在人数少的时候也可以玩。他现在有一次改变形态的机会，以生存空间换取更多爆发。

#### 看戏

锁定技，一名其他角色受到伤害后，若伤害来源不为你，你摸等同于伤害值张牌。

#### 入局

限定技，出牌阶段，你可以减一点体力上限，将〖看戏〗改为所有伤害均可触发摸牌。
