...
依次填入画横线部分最恰当的一项是：]],
  ...
  -- 32
  {
    [[近年来，西方观众对中国功夫片的套路、动作、术语等已颇为熟悉，中国功夫的神秘感、陌生感在他们眼中逐渐________，所以中国功夫片要体现作品的________，很有难度。当下国产功夫电影在制作和传播方面并非________，收获的口碑和奖杯都很难超越传统功夫片。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、淡化  独特性  高枕无忧]],
      [[B、消失  差异性  一帆风顺]],
...
这段文字主要介绍了：]],
  ...
  -- 37
  {
    [[虽然中国的救灾能力在经历过多次大型自然灾害后有了较大的提升，但是防灾教育依然落后。中国扶贫基金会2015年对中国公众的防灾意识进行了调查，结果显示，仅有24.3%%的城市居民表示关注灾害应对的相关知识，这一数据在农村仅为11%%。此外，只有不到4%%的城市居民在日常生活中做了基本的防灾准备，超过半数的农村居民从未参加过任何防灾培训。形同虚设的防灾教育无法提高民众的自救能力，等到灾难发生后才开始组织学习，逝去的生命已经无法挽回。<br>
这段文字意在说明：]],
    {
      [[A、防灾教育比救灾更重要]],
      [[B、中国的防灾教育亟待加强]],
