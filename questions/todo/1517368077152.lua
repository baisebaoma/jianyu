...
④非公有制经济仅限于个体经济，不包括私营经济，且个体经济处于补充地位]],
  ...
  -- 21
  {
    [[生命在于运动，运动能塑造我们强健的身体，增强抵抗疾病的能力。当然，它对大脑也是有益的。但事实上，运动应该，否则会使人反应迟钝。长时间大强度运动会使脑组织兴奋性降低，会使能源物质ATP（腺嘌呤核苷三磷酸）耗竭，对大脑机能造成损害。<br>
填入画横线部分最恰当的一项是：]],
    {
      [[A、因人而异]],
      [[B、张弛有道]],
...
依次填入画横线部分最恰当的一项是：]],
  ...
  -- 25
  {
    [[一项世界规模的宏基因组研究显示，含耐药基因的微生物在自然界中。这意味着人类有可能回到没有抗生素的时代，医疗体系中的很大一部分可能会退回到抗生素发明之前的境地，轻微的细菌感染都可能引起的后果。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、比比皆是  意外]],
      [[B、不可胜数  可怕]],
...
依次填入画横线部分最恰当的一项是：]],
  ...
  -- 30
  {
    [[开花的塔黄零星分布在空旷的流石滩上，蕈蚊是如何及时发现它们的呢？原来蕈蚊头上的触角就像人类的鼻子，能感受并不同的气味。开花的塔黄会挥发20多种化合物，其中一种不常见的化合物（二甲基丁酸甲酯）占所有化合物的左右。野外诱导试验证实，这种化合物可以传粉的蕈蚊，为其“导航”。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、记忆  引诱]],
      [[B、区分  吸引]],
  ...
  -- 31
  {
    [[秦岭阻挡了中国腹地南北气候的交互，却挡不住秦巴两地行者的脚步。无论是“明修栈道，暗度陈仓”，还是“一骑红尘妃子笑”，都与一条条秦岭古道。这些古道就如同一条条经线，沟通了关中与巴蜀，见证了中国历史的朝代兴替与政经融通，出不少故事与传说。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、密不可分  演绎]],
      [[B、交相辉映  衍生]],
  ...
  -- 32
  {
    [[医疗改革方案将引导医疗机构、医务人员，通过提供更多更好的诊疗服务，获得的补偿。对于过度治疗问题，该方案是一种的做法，它让医生的收入与所开的药物、检查脱钩，让医疗工作者的劳动收入真正体现在明处。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、合法  立竿见影]],
      [[B、公正  行之有效]],
...
这段文字反驳了哪种观点？]],
  ...
  -- 55
  {
    [[进行骨髓移植的前提条件是有配型成功的捐赠者。双胞胎配型成功几率最高，兄弟姐妹也有可能。但在中国，20世纪70年代到现在，大多数都是独生子女，有兄弟姐妹且能配型成功的概率也非常低。另外，父母和子女之间骨髓配型成功的概率非常低，几乎为零。因此，绝大多数患者都必须依赖不认识的志愿者配型。非亲缘关系骨髓配型成功的几率只有几十万至几百万分之一，。<br>
填入画横线部分最恰当的一句是：]],
    {
