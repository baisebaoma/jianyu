-- 试卷来源：https://www.gkzenti.cn/paper/1517368116649，答案来源：https://www.gkzenti.cn/answer/1517368116649，
-- 由爬虫自动生成，请手动检查：
...
④非公有制经济仅限于个体经济，不包括私营经济，且个体经济处于补充地位]],
  ...
  -- 9
  {
    [[下面是对我国一份近代历史文献的描述：是一份改革内政和建设国家的新方案；是发展资本主义的近代化纲领；因脱离当时社会现实而未能实施。<br>
这份文献可能是：]],
    {
      [[A、《海国图志》]],
      [[B、《资政新篇》]],
  ...
  -- 13
  {
    [[下列诗句所描述情景出现的时间与图中标示的时间段，对应正确的是：<br>
]],
    {
  ...
  -- 21
  {
    [[如今，一批70后、80后甚至更年轻的年画传承人涌现出来。这些年轻人开始有了清醒的文化自觉，对中华传统文化怀有浓厚的兴趣，怀着敬畏之心钻研，并不，急于进入市场大潮，冯骥才称他们为“年画的新力量”。<br>
填入画横线部分最恰当的一项是：]],
    {
      [[A、随波逐流]],
      [[B、沽名钓誉]],
  ...
  -- 22
  {
    [[情绪并不是独立存在的，它常常伴随着信息而传播。作为一种态度，情绪不仅能够人们对所传播信息的认知，还会在一定程度上指导人们的行为。积极的情绪会促进人们积极地认识世界，消极的情绪则可能给他人甚至整个社会带来破坏性后果。人在情绪失控时，很容易不顾后果地做出的举动。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、影响  危险]],
      [[B、左右  出格]],
  ...
  -- 23
  {
    [[在联合国教科文组织通过的《文化多样性宣言》和《保护非物质文化遗产公约》里，文化的多样性都被比喻成生物的多样性。因为人类的文化创造和遗存就像人类的基因，包含了过去世代累积的信息和发展的可能性。有些看似的东西，今天不知道它有什么重要性，但以后可能会影响到人类的发展。<br>
填入画横线部分最恰当的一项是：]],
    {
      [[A、司空见惯]],
      [[B、转瞬即逝]],
  ...
  -- 24
  {
    [[历史认识的局限性成就了历史研究的魅力。历史认识有局限性，才需要人们不断拷问、修正和创新。如果研究者因此而敬畏研究对象，兢兢业业，，这正是历史研究的幸事。反之，如果把历史认识的局限性作为规避责任的遁词和主观臆断的托词，人们就会愈发相信历史毫无可言。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、身体力行  科学性]],
      [[B、恪尽职守  公平性]],
  ...
  -- 25
  {
    [[射电天文学的进步把人们的视线引向了宇宙遥远的边缘，那里了更多有关宇宙起源和演化的关键线索。天文学家都渴望拥有威力更加强大的射电望远镜，谁拥有了这种望远镜，谁就更有可能站立在现代物理学和天文学的潮头，，成为破解宇宙之谜的领军力量。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、暗藏  胜券在握]],
      [[B、隐藏  捷足先登]],
  ...
  -- 26
  {
    [[黄河三角洲是中国大河三角洲中海陆变迁最的地区，特别是黄河口地区造陆速率之快、尾闾迁徙之频繁，更为世界罕见。黄河三角洲的受黄河水沙条件和海洋动力作用的制约，黄河来沙使海岸堆积向海洋推进，海洋动力作用又使海岸侵蚀向陆地推进。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、壮观  形成]],
      [[B、复杂  形态]],
  ...
  -- 27
  {
    [[中俄计划携手建设从莫斯科出发，穿越哈萨克斯坦通往北京的欧亚高速运输走廊。新铁路的兴建可能要耗时八至十年。从工程的规模及价值来看，它堪与苏伊士运河。后者大幅缩短了通航里程及时间，迅速对全球贸易产生了的影响。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、比肩  不可估量]],
      [[B、媲美  旷日持久]],
  ...
  -- 28
  {
    [[就文学创作而言，人工智能未来有可能在编剧或网络文学方面有所，毕竟除了一小部分杰出的作品外，无论剧本创作还是网络文学，都比较依赖标准化的情节与词语搭配。而文学作品的程度越高，越有可能人工智能化。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、建树  程式化]],
      [[B、发展  通俗化]],
  ...
  -- 29
  {
    [[早在上世纪70年代末，钱学森就曾多次提出：国防科技的发展不能于“追尾巴”“照镜子”，而是要地开拓新领域和新方向。比如英国人针对重机枪机动性差的弱点，发明了坦克，一举撕裂了枪炮林立的僵持局面。这类非对称式的发展思路有助于打破先进国家的技术垄断，形成后发优势。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、拘泥  与众不同]],
      [[B、满足  独辟蹊径]],
  ...
  -- 30
  {
    [[大国兴衰构成了世界历史的重要篇章，许多学者和政治家探寻其中的逻辑线索，产生了许多著述宏论。然而，对大国兴衰的原因难有最终答案，这不仅在于问题本身的，更是因为世界在变化，不同国家兴衰的轨迹不可能简单重复。因此，对这一问题的探讨永远不会。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、殚精竭虑  阶段性  终结]],
      [[B、废寝忘食  多样性  沉寂]],
  ...
  -- 31
  {
    [[一些人对传统文化的理解存在误区，认为凡是老祖宗传下来的文化遗产，就不能有丝毫的改变，必须在当代地得到传承。这种认识或许有助于传统文化的经典性，但这也决定了传统文化只能被小众欣赏。这名为保护传统，实则了传统与现实，终将使得传统文化被历史尘埃所湮没。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、一板一眼  凸显  混淆]],
      [[B、原汁原味  维护  模糊]],
  ...
  -- 32
  {
    [[近年来，西方观众对中国功夫片的套路、动作、术语等已颇为熟悉，中国功夫的神秘感、陌生感在他们眼中逐渐，所以中国功夫片要体现作品的，很有难度。当下国产功夫电影在制作和传播方面并非，收获的口碑和奖杯都很难超越传统功夫片。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、淡化  独特性  高枕无忧]],
      [[B、消失  差异性  一帆风顺]],
  ...
  -- 33
  {
    [[一方面，受世界经济影响，大宗资源产品价格走低，资源型企业纷纷陷入困境，资源型城市财政收入也急剧下降，无力增加投入；另一方面，随着经济发展进入新常态，大规模经济刺激已经，来自中央政府的强力支持相应减弱，资源型城市债务扩张趋于收紧。资源型城市转型面临的资金约束日益。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、下行  失效  紧张]],
      [[B、萎缩  放缓  强化]],
  ...
  -- 34
  {
    [[漆画有其他画种达不到的效果，同时也有它的。它不能像油画、水粉画那样自由地运用冷暖色彩，不能像素描那样丰富地运用明暗层次，不善于逼真地、地再现对象。事实上，在似与不似之间表现对象，才是漆画最的地方。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、问题  出神入化  出色]],
      [[B、短板  惟妙惟肖  难得]],
  ...
  -- 35
  {
    [[在执行任务期间，“反潜持续追踪无人艇”一旦发现目标的，就会使用声纳系统对目标进行定位并跟踪，同时借助传感器技术进行信息。逼近目标时，无人艇会通过声学图像，确定目标潜艇的型号等信息，再将数据传输到反潜指挥中心，由中心指派就近的反潜平台赶往目标海域，摧毁敌艇。<br>
依次填入画横线部分最恰当的一项是：]],
    {
      [[A、踪迹  精确  搜集]],
      [[B、意图  精准  汇总]],
...
这段文字主要介绍了：]],
  ...
  -- 37
  {
    [[虽然中国的救灾能力在经历过多次大型自然灾害后有了较大的提升，但是防灾教育依然落后。中国扶贫基金会2015年对中国公众的防灾意识进行了调查，结果显示，仅有的城市居民表示关注灾害应对的相关知识，这一数据在农村仅为。此外，只有不到的城市居民在日常生活中做了基本的防灾准备，超过半数的农村居民从未参加过任何防灾培训。形同虚设的防灾教育无法提高民众的自救能力，等到灾难发生后才开始组织学习，逝去的生命已经无法挽回。<br>
这段文字意在说明：]],
    {
      [[A、防灾教育比救灾更重要]],
      [[B、中国的防灾教育亟待加强]],
...
这段文字意在：]],
  ...
  -- 47
  {
    [[当我们仔细观察当今世界上的主流火箭时，就会发现它们用的发动机、燃料箱等都是上世纪的产物。比如要在2018年首飞的太空发射系统用的是改进过的航天飞机的火箭发动机，燃料箱用的是改进过的航天飞机的外挂燃料箱，两侧的固体燃料推进器用的也是改进过的航天飞机的固体燃料推进器。。火箭是非常复杂的东西，设计并制造火箭需要考虑的因素太多，就连火箭制造商们也只能去选择一些经受过时间考验的产物，从而确保产品的可靠性。<br>
填入画横线部分最恰当的一句是：]],
    {
      [[A、这是因为新技术的推广需要一定的时间]],
...
奇妙的是，失去了这个基因的两位女孩不但活着，而且身体大致健康，这就引起了伯内曼教授极大的兴趣。进一步研究发现，两人的皮肤感觉功能都有问题，她们感觉不到震动的音叉。如果用软毛刷子轻轻刷过两人的手掌心，两人都感觉不到。但如果用软毛刷子轻轻刷过有汗毛的皮肤，两人虽然可以感觉得到，但却觉得像是有人拿小针扎似的，而不是像大多数人那样会有一种美好的感觉。]],
  ...
  -- 71
  {
    [[一艘非法渔船作业时发现其正右方有海上执法船，于是沿下图所示方向左转后，立即以15节（）的速度逃跑，同时执法船沿某一直线方向匀速追赶，并正好在某一点追上。已知渔船在被追上前逃跑的距离刚好与其发现执法船时与执法船的距离相同，问执法船的速度为多少节？<br>
]],
    {
      [[A、20]],
      [[B、30]],
  ...
  -- 74
  {
    [[某饲料厂原有旧粮库存袋，现购进袋新粮后，将粮食总库存的精加工为饲料。被精加工为饲料的新粮最多为袋，最少为袋。如所有旧粮、新粮每袋重量相同，则以下哪个坐标图最能准确描述、分别与的关系？<br>
]],
    {
      [[A、A]],
      [[B、B]],
  ...
  -- 76
  {
    [[从所给的四个选项中，选出最合适的一个填入问号处，使之呈现一定的规律性：<br>
]],
    {
      [[A、A]],
      [[B、B]],
  ...
  -- 80
  {
    [[左图给定的是正方体纸盒的外表面，下面哪一项能由它折叠而成？<br>
]],
    {
      [[A、A]],
      [[B、B]],
  ...
  -- 81
  {
    [[左图为给定的多面体，从任一角度观看，下面哪一项不可能是该多面体的视图？<br>
]],
    {
      [[A、A]],
      [[B、B]],
  ...
  -- 82
  {
    [[下面四个立体图形中，哪一项不能用一个平面分割为两个完全相同或互为镜像的部分？<br>
]],
    {
      [[A、A]],
      [[B、B]],
...
以上观点的前提是：]],
  ...
  -- 107
  {
    [[有一种理论认为，距今约5000万年前，生活在马达加斯加岛上的环尾狐猴、狐蝠以及其他哺乳动物的祖先当年乘坐天然的“木筏”，来到了马达加斯加这座位于印度洋的岛屿上。根据这一理论，来自非洲大陆东南部的哺乳动物当年漂流到马达加斯加，它们利用的交通工具是大原木或者漂浮的植被。在上演漂流记前，风暴将它们卷入大海，在洋流的带动下，这些古代“难民”漂流数周，来到马达加斯加。<br>
以下哪项如果为真，不能支持上述漂流理论？]],
    {
...
这项调查最能支持的论断是：]],
  ...
  -- 109
  {
    [[某省游泳队进行了为期一个月的高原集训，集训最后一日所有队员进行了一次队内测试，几位教练预测了一下队员的成绩：<br>
张教练说：这次集训时间短，没人会达标。<br>
孙教练说：有队员会达标。<br>
王教练说：省运会冠军或国家队队员可达标。<br>
测试结束后，只有一位教练的预测是正确的。<br>
由此可以推出：]],
    {
      [[A、没有人达标]],
      [[B、全队都达标了]],
  ...
  -- 110
  {
    [[某公司30岁以下的年轻员工中有一部分报名参加了公司在周末举办的外语培训班。该公司的部门经理一致同意在本周末开展野外拓展训练。所有报名参加外语培训班的员工都反对在本周末开展拓展训练。<br>
由此可以推出：]],
    {
      [[A、所有部门经理年龄都在30岁以上]],
...
以下哪项如果为真，最能质疑研究者的结论？]],
  ...
  -- 112
  {
    [[开车斗气、胡乱变线、强行超车等“路怒症”是一种被称为间歇性、暴发性障碍(IED)的心理疾病。有研究发现，IED患者弓形虫检测呈阳性的比例是非IED组的两倍。研究者认为，弓形虫感染有可能是导致包括“路怒症”在内的IED的罪魁祸首。<br>
以下哪项如果为真，无法支持研究者的观点？]],
    {
...
以下哪项如果为真，不能削弱上述结论？]],
  ...
  -- 115
  {
    [[某次会议讨论期间，甲、乙、丙、丁、戊被安排在一张圆桌前进行讨论，圆桌边放着标有1～5号的五张座椅(未必按序排列)。实际讨论时，甲、乙、丙、丁、戊5人均未按顺序坐在1～5号的座椅上，已知：<br>
（1）甲坐在1号座椅右边第二张座椅上；<br>
（2）乙坐在5号座椅左边第二张座椅上；<br>
（3）丙坐在3号座椅左边第一张座椅上；<br>
（4）丁坐在2号座椅左边第一张座椅上。<br>
如果丙坐在1号座椅上，则可知甲坐的是哪个座椅？]],
  ...
  -- 124
  {
    [[以下哪项最能准确描述2016年生活服务电商市场中，三个不同细分市场交易规模同比增量的比例关系？<br>
]],
    {
      [[A、A]],
      [[B、B]],
